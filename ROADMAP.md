...
- [ ] Phase 10: Application-level Event Bus (s6-notifications + Unix-socket JSON)
...
## TIER: RESEARCH
- [ ] Phase 15: Qubes-inspired microVM Stack (NetVM, Disposable VM, Wayland+waypipe GUI isolation)
